					...
					if upSpell
						...
						if upScroll
							float weightedActorAVSum = 1.0 + \
								0.0025 * ThisActor.GetAV("Enchanting") + \
								0.0005 * ThisActor.GetAV("Alteration") + \
								0.0005 * ThisActor.GetAV("Conjuration") + \
								0.0005 * ThisActor.GetAV("Destruction") + \
								0.0005 * ThisActor.GetAV("Illusion") + \
								0.0005 * ThisActor.GetAV("Restoration")
